...
// Single source of truth for the Pi runtime Dispatch ships with. package.json
// must pin the same exact version; pi-version.test.mjs enforces the match.
export const PI_PINNED_VERSION = '0.87.1';
export const PI_PINNED_SPEC = `@earendil-works/pi-coding-agent@${PI_PINNED_VERSION}`;
