...
Only you spawn subagents. Serialize edits across general and fast workers in the shared workspace. Research may run concurrently when it does not depend on files being changed. Use the provided wait/completion mechanism instead of repeatedly polling.
