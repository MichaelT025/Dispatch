...
for (const file of ['extensions/piastra/index.ts', 'extensions/piastra/policy.mjs', 'extensions/piastra/agents.mjs', 'extensions/piastra/prefs.mjs', 'extensions/piastra/guard.mjs', 'extensions/piastra/progress.mjs', 'extensions/piastra/sidebar.mjs', 'extensions/piastra/worker-bridge.mjs', 'extensions/piastra/worker-runtime.mjs', 'extensions/piastra/worker-evidence.mjs', 'extensions/piastra/worker-models.mjs', 'extensions/piastra/session-title.mjs', 'extensions/piastra/worker-view.ts', 'extensions/piastra/help.mjs', 'extensions/piastra/help-view.ts', 'extensions/piastra/worker-panel.ts', 'extensions/piastra/worker-render.ts', 'extensions/piastra/shortcuts.ts', 'extensions/piastra/image-paste.ts', 'extensions/piastra/custom-tools.ts', 'extensions/piastra/notes.mjs', 'extensions/piastra/web.mjs', 'extensions/piastra/checks.mjs', 'extensions/piastra/windows-check-job.ps1', 'extensions/pi-worktree/git-worktree.ts', 'extensions/pi-worktree/resume.mjs', 'extensions/pi-worktree/empty-sessions.mjs', 'extensions/pi-worktree/LICENSE', 'config/agents.json', 'config/checks.json', ...['orchestrator', 'general', 'fast', 'review'].map(role => `roles/${role}.md`)]) {
