// PiAstra fork divergence: the single @juicesharp/rpiv-config import is
// redirected to the pristine in-tree vendored copy (vendor/rpiv-config/)
// so this extension loads self-contained with no external rpiv-config
// package on disk. Everything else in this file is upstream-verbatim.
