...
export const helpSections = [
  ...
  },
  {
    ...
    lines: [
      ...
      '- "N workers still running...": wait for their results, or ask the',
      '  orchestrator to cancel them, before switching sessions. Same for',
      '  compaction/branch-summary waits.',
